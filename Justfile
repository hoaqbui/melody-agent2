...
package-ui:
    ...
    codesign --force --deep --sign - --entitlements ui/desktop/entitlements.plist ui/desktop/out/Melody-darwin-arm64/Melody.app
    @echo "Done! Launch with: open ui/desktop/out/Melody-darwin-arm64/Melody.app"
