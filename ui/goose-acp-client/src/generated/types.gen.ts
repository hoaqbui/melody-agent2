 ...
 */
export type ListScheduleRunsRequest_unstable = {
    limit: number;
};

export type ListScheduleRunsResponse_unstable = {
    runs: Array<ScheduleRunDto>;
};
...
export type ScheduleRunOutcomeDto = {
 ...
 */
export type GetSessionChildrenRequest_unstable = {
    sessionId: string;
};

export type GetSessionChildrenResponse_unstable = {
    sessions: Array<SessionInfo>;
};
