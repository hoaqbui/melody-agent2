...
import { loadProjectEntry, saveProjectEntry, loadTurnSnapshots, saveTurnSnapshot } from './project-storage';
import {
  MODE_MESSAGES,
  RoutineChip,
  SessionChips,
...
export function WorkspaceShell({ chat, children, panes, paneStore }: WorkspaceShellProps) {
  ...
  useEffect(() => {
    ...
    const wasStreaming = prevChatState === ChatState.Streaming || prevChatState === ChatState.Thinking;
