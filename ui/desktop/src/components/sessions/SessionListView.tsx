...
const i18n = defineMessages({
  ...
  importNostrDesc: {
    ...
    defaultMessage: 'Paste a Melody Nostr share link to fetch, decrypt, and import the session.',
  },
  ...
  chatHistoryDesc: {
    ...
    defaultMessage: 'View and search your past conversations with Melody. {shortcut} to search.',
  },
