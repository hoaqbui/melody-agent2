...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using Melody.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve Melody. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
