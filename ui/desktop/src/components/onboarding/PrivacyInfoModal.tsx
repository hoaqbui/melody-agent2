...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Anonymous usage data helps us understand how Melody is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'Melody version and install method',
  },
  collectProvider: {
