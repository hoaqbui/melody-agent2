...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'Melody is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'Melody is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'Melody is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'Melody is compacting the conversation...',
  },
  idle: {
