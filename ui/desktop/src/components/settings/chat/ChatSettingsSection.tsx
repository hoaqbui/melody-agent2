...
const i18n = defineMessages({
  ...
  modeDescription: {
    ...
    defaultMessage:
      'Choose the default mode Melody uses for new sessions. Existing sessions keep their current mode.',
  },
  responseStylesTitle: {
  ...
  responseStylesDescription: {
    ...
    defaultMessage: 'Choose how Melody should format and style its responses',
  },
});
