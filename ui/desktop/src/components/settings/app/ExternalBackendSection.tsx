...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default Melody starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. Melody checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart Melody to update existing windows.',
  },
  urlProtocolError: {
