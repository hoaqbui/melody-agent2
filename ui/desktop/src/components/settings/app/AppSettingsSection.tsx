...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how Melody appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when Melody finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show Melody in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show Melody in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while Melody is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of Melody',
  },
  ...
  phoneDesc: {
    ...
    defaultMessage: 'Open Melody on your phone over the tailnet — scan the code or copy the address',
  },
  phoneNoTailnet: {
    id: 'settings.phone.noTailnet',
    defaultMessage: 'No tailnet address — start Tailscale and relaunch Melody',
  },
  ...
  languageDesc: {
    ...
    defaultMessage: 'Choose the display language for Melody',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve Melody by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep Melody running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select Melody in the application list',
  },
